...
export default async function aggregateLogs(req: Request, res: Response) {
    ...
    try {
        ...
        } else if (checkLogsToday.rows && checkLogsToday.rows.length < 1) {
            await db.query('INSERT INTO api_usage_aggregate (api_key, endpoint, date, request_count, total_response_time_ms, error_count, query_params) VALUES ($1, $2, $3, $4, $5, $6, $7)', ['NULL', '/', yesterday, 0, 0, 0, []]);
