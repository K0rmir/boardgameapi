...
export async function Logger(req: Request, statusCode: number, responseTime: number) {
    try {
        await db.query('INSERT INTO api_usage_logs (api_key, endpoint, method, status_code, response_time_ms, query_params) VALUES ($1, $2, $3, $4, $5, $6)', [req.hashedApiKey, req.path, req.method, statusCode, responseTime, Object.keys(req.query)]);
